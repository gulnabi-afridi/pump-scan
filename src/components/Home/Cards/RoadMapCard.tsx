...
const RoadMapCard: React.FC<Props> = ({ index, title, list }: Props) => {
  return (
    <div className={`w-full h-full gradient-wrapper p-[1px] rounded-[16px]`}>
      <div className='w-full borderGradient h-full flex flex-col rounded-[16px]'>
        <div className='w-full p-3 sm:p-5 gap-2 h-[60px] sm:h-[80px] flex border-b-[1px] border-black-2 justify-between items-center'>
          <h3 className='text-white-1 text-[18px] font-gesistMedium'>
            {title}
          </h3>
